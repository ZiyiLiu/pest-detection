...
flags = tf.app.flags
flags.DEFINE_string('data_dir', '', 'Root directory to main data directory.')
flags.DEFINE_string('images_dir', 'images', 
    '(Relative) directory of image directory to data_dir.')
flags.DEFINE_string('annotations_dir', 'xml', 
    '(Relative) directory of annotations to data_dir.')
flags.DEFINE_string('set', 'train', 
    'Convert training set, validation set or merged set.')
flags.DEFINE_string('output_path', '', 
    'Path output TFRecord')
...
def main(_):
    ...
    output_path = os.path.join(data_dir, FLAGS.output_path)
    ...
    for idx, example in enumerate(examples_list):
        ...
        sub_images_dir = example.split('/')[0]
        tf_example = dict_to_tf_example(data, FLAGS.data_dir, label_map_dict,
            FLAGS.ignore_difficult_instances, 
            image_subdirectory=os.path.join(images_dir, sub_images_dir))
